...
func (c *productDB) UpdatCategory(ctx context.Context, category requests.Category, id int) (response.Category, error) {
...
func (c *productDB) ViewAllProducts(ctx context.Context, pagination requests.Pagination) (products []response.Product, err error) {
